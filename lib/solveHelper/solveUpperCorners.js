...
function solveUpperCorners(cube) {
    var helper = {
    ...
    logManager_1.LogManager.log('Solved upper corners', logManager_1.LogLevel.success);
}
exports.solveUpperCorners = solveUpperCorners;
